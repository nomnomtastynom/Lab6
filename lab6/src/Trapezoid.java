 ...
 * https://math.stackexchange.com/questions/2637690/is-there-a-formula-to-
 * calculate-the-area-of-a-trapezoid-knowing-the-length-of-al?rq=1
 *
 * @author Stephen
 * @version 2019-02-18
 */
...
{
    /**
     * The variables storing the lengths of the left/right sides of the
     * trapezoid and the lengths of the top/bottom bases.
     */
    private double leftSide, rightSide, topBase, bottomBase;

    /**
     * The rectangle constructor. Store the side and base information and store
     * in the sideLengths array.
     *
     * @param id
