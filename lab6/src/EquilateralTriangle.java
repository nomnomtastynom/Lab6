...
public class EquilateralTriangle extends Polygon
{
    ...
    /**
     * Constructor for the equilateral triangle. Sets sideLength member variable
     * and sets all side length in Polygon sidelengths array.
     *
     * @param sidelength
     ...
     *
     * @return The area of the triangle (b*h/2 =
     *         sidelength*sidelength*root(3)/4)
     */
    @Override
    public double getArea()
    {
        // TODO: complete this...
        double equilTriArea = Math.pow(this.sideLength, 2) * Math.sqrt(3) / 4;
        return equilTriArea;
    }
