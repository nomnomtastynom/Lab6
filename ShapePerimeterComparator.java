...
public class ShapePerimeterComparator implements Comparator<Shape>
{
     ...
     *
     * Look to the documentation in Shape's compareTo to better understand how
     * this should work.
     *
     * @param s1
     ...
     *         conditions: (1) Perimeter of s1 is < perimeter of s2: return -1
     *         (2) Perimeter of s1 is > perimeter of s2: return 1 (3) Perimeter
     *         of s1 = perimeter of s2:
     */
    @Override
     ...
     * perimeter). You should use the compare() method of this class to
     * determine this.
     *
     * @param s1
     *            The first shape to be compared.
