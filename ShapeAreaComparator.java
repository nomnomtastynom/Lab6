...
public class ShapeAreaComparator implements Comparator<Shape>
{
     ...
     *         conditions: (1) Area of s1 is < area of s2: return -1 (2) Area of
     *         s1 is > area of s2: return 1 (3) Area of s1 = area of s2:
     */
    @Override
     ...
     * area). You should use the compare() method of this class to determine
     * this.
     *
     * @param s1
     *            The first shape to be compared.
    ...
    {
        // TODO: complete this...
        int valueComparison = compare(s1, s2);
